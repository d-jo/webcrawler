...
grpc_entity: ./entity/entity.proto 
	protoc -I=./entity --go_opt=paths=source_relative --go_out=./entity/ entity/*.proto

grpc_service: ./usecase/crawler/crawler.proto grpc_entity
	protoc --go_opt=paths=source_relative --go_out=./usecase/crawler --proto_path=./entity --proto_path=./usecase/crawler usecase/crawler/crawler.proto
